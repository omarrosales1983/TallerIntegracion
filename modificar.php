...
$caracteresrut=9;//definimos la cantidad de caracteres del rut
			...
			//valida si el rut se encuentra registrado
if($resultado = mysqli_query($conectar,$buscarrut))
	...
	else
	{
		...
		//verificamos si los campos se encuentran vacio o con información
if(!$nombre)
{
...
{
$actualizar="update usuarios set nombre='$nombre',telefono='$telefono',correo='$correo' where rut='$rut'";
mysqli_query($conectar,$actualizar);

$bitacora="insert into bitacora (usuario,fecha,accion) values ('admin',NOW(),'modifica registro')";
...
?>
<!--este es un menu de navegación dentro de nuestro formuario html -->
<div id="navegación">
...
<body>
<br><h3>Modificar Datos</h3>
<h4>Para modificar datos ingrese Rut</h4>
<form name="ingresar" method="post" action="modificar.php">
<fieldset>
